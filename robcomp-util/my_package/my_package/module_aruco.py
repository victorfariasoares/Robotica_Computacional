...
class Aruco3d():
    def __init__(self,
            ...
            '/home/borg/colcon_ws/src/robcomp-util/my_package/config/cameraMatrix_realsense.txt', delimiter=',')
            self.camera_distortion = np.loadtxt(
            '/home/borg/colcon_ws/src/robcomp-util/my_package/config/cameraDistortion_realsense.txt', delimiter=',')
